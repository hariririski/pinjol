...
<html lang="en">
  <head>
    ...
    <title>Pinjol - Pinjaman Arsip Online</title>
    <!-- Google font-->
              ...
              <li>
                <form class="form-inline search-form">
                  <div class="search-bg"><i class="fa fa-search"></i>
                    <input class="form-control-plaintext" placeholder=" Daftar Pemintaan Peminjaman Arsip Pertanahan Kantor Pertanahan Kota Banda Aceh">
                  </div>
          ...
          <div class="nav-right col pull-right right-menu p-0">
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown p-0">
                <button class="btn btn-primary-light" type="button"><a href="<?php echo base_url(); ?>masuk"><i data-feather="log-in"></i>Masuk</a></button>
              </li>
            </ul>
          </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright 2023 © Pinjol - Pinjaman Online </p>
              </div>
              <div class="col-md-6">
                <p class="pull-right mb-0">Kantor Pertanahan Kota Banda Aceh</i></p>
              </div>
            </div>
          </div>
        </footer>
